...
# ---------- PAGE LAYOUT ----------
    ...
    with left:
        st.markdown("""
        <div style="color:white; padding-top:180px; padding-left:60px">
        ...
        Monitor competitor insulation prices across multiple suppliers
        and analyze market trends instantly.
        </p>

        <ul style="font-size:17px; line-height:1.8">
        <li>📊 Compare competitor prices instantly</li>
        <li>📈 Track price trends over time</li>
        <li>🏷 Monitor multiple insulation brands</li>
        <li>⚡ Daily updated market data</li>
        </ul>
    ...
    with right:
        ...
        <div style="text-align:center">
            <img src="https://cdn.shopify.com/s/files/1/0250/6198/2261/files/Insulation4less_main_logo.png?v=1767346032" width="320">
        </div>
        """, unsafe_allow_html=True)

        st.markdown(
            "<h2 style='text-align:center;color:white'>Login In</h2>",
            unsafe_allow_html=True
        )
